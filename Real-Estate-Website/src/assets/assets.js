//importing all the images in this js file  
...
//Creating an array for the project detail 
...
export const projectsData = [
  ...
  //Another array for the all the testimonial data
  //for the customer detail line name ,title, etc 
